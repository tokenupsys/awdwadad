    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="text-secondary flex flex-col gap-4">
        ...
        <p>
          ...
          <ExternalLink arrow={false} href="https://discord.tokenup.store">
            TokenUp
          </ExternalLink>{' '}
          developing the{' '}
          <ExternalLink href="https://discord.tokenup.store">
            Tools for the web
          </ExternalLink>{' '}
          , and at{' '}
        ...
        <p>
          Currently studying Computer Science. Experience,
          of 7 Years by improving consistently through learning.
        </p>
      </div>
    </div>
  );
